...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", "-i", default='/home/xingyu/gs_ws/SCube-release/waymo_tfrecords', type=str, required=False, help="Root directory of waymo dataset (tfrecord files).")
    parser.add_argument("--output_dir", "-o", default='/home/xingyu/gs_ws/SCube-release/waymo_ns', type=str, required=False, help="Output directory of extracted data.")
    # parser.add_argument("--output_dir", "-o", default='/mnt/data_nas/data/xingyu/waymo/waymo_ns', type=str, required=False, help="Output directory of extracted data.")
    parser.add_argument("--no_lidar", default=False, action="store_true", help="Do not extract lidar data.")
    ...
    parser.add_argument("--specify_segments", default=["933621182106051783_4160_000_4180_000"], nargs="+")
